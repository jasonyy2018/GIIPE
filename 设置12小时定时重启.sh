...
# 设置每12小时自动重启前端容器（防止15分钟后问题）

set -e

echo "=========================================="
echo "⏰ 设置每12小时自动重启前端容器"
echo "=========================================="
echo ""
...
PROJECT_DIR=$(pwd)
CRON_JOB="0 */12 * * * cd $PROJECT_DIR && docker-compose -f docker-compose.prod.yml restart frontend >> /var/log/frontend-restart.log 2>&1"
